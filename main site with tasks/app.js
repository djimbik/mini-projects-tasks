...
const taskModel = new TaskModel([
    ...
    {
        id: Date.now() + 5,
        title: `Objects: Задание #6 (дополнительное), Повторов: 0`,
        isDone: false,
    },
    {
        id: Date.now() + 6,
        title: `Objects: Задание #7 (дополнительное), Повторов: 0`,
        isDone: false,
    },
    {
        id: Date.now() + 7,
    ...
    {
        id: Date.now() + 8,
        title: `Date: Задание #1, Повторов: 0`,
        isDone: false,
    },
    {
        id: Date.now() + 9,
        title: `Date: Задание #2, Повторов: 0`,
        isDone: false,
    },
    {
        id: Date.now() + 10,
    ...
    {
        id: Date.now() + 11,
        title: `Date: Задание #4, Повторов: 0`,
        isDone: false,
    },
    {
        id: Date.now() + 12,
    ...
    {
        id: Date.now() + 17,
        title: `Classes and OOP: Задание #2, Повторов: 0`,
        isDone: false,
    },
    {
        id: Date.now() + 18,
        title: `Classes and OOP: Задание #3, Повторов: 0`,
        isDone: false,
    },
    {
        id: Date.now() + 19,
        title: `Classes and OOP: Задание #4, Повторов: 0`,
        isDone: false,
    },
    {
        id: Date.now() + 20,
        title: `Classes and OOP: Задание #5, Повторов: 0`,
        isDone: false,
    },
    {
        id: Date.now() + 21,
