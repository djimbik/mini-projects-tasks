...
const taskModel = new TaskModel([
    ...
    {
        id: Date.now() + 6,
        title: `Objects: Задание #7 (дополнительное), Повторов: 2`,
        isDone: true,
    },
    {
        id: Date.now() + 7,
    ...
    {
        id: Date.now() + 15,
        title: `Ключевое слово this: Задание #4, Повторов: 2`,
        isDone: true,
    },
    {
        id: Date.now() + 16,
        title: 'Classes and OOP: Задание #1, Повторов: 2',
        isDone: true,
    },
    {
        id: Date.now() + 17,
        title: `Classes and OOP: Задание #2, Повторов: 2`,
        isDone: true,
    },
    {
        id: Date.now() + 18,
    ...
    {
        id: Date.now() + 27,
        title: `DOM: Задание #5, Повторов: 2`,
        isDone: true,
    },
    {
        id: Date.now() + 28,
    ...
    {
        id: Date.now() + 27,
        title: `Асинхронность (Promise + Fetch): Задание #1, Повторов: 2`,
        isDone: true, 
    },
    {
        id: Date.now() + 28,
        title: `Асинхронность (Promise + Fetch): Задание #2, Повторов: 2`,
        isDone: true, 
    },
    {
        id: Date.now() + 29,
        title: `Асинхронность (Promise + Fetch): Задание #3, Повторов: 1`,
        isDone: true,
    },
    {
        id: Date.now() + 30,
        title: `Асинхронность (Promise + Fetch): Задание #4 (дополнительное), Повторов: 1`,
        isDone: true,
    },
    {
        id: Date.now() + 31,
        title: `Асинхронность (Async Await): Задание #1, Повторов: 1`,
        isDone: true,
    },
    {
        id: Date.now() + 32,
        title: `Асинхронность (Async Await): Задание #2, Повторов: 2`,
        isDone: true, 
    },
    {
        id: Date.now() + 33,
